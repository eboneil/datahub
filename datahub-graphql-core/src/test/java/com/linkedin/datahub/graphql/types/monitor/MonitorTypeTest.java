...
public class MonitorTypeTest {
  ...
  private static final String TEST_MONITOR_URN = String.format("urn:li:monitor:(%s,guid-1)", TEST_ENTITY_URN);
  ...
  public void testBatchLoad() throws Exception {
    ...
    com.linkedin.datahub.graphql.types.monitor.MonitorType type = new com.linkedin.datahub.graphql.types.monitor.MonitorType(client);

    QueryContext mockContext = Mockito.mock(QueryContext.class);
    Mockito.when(mockContext.getAuthentication()).thenReturn(Mockito.mock(Authentication.class));
    List<DataFetcherResult<Monitor>> result = type.batchLoad(ImmutableList.of(TEST_MONITOR_URN, TEST_MONITOR_URN_2), mockContext);
  ...
  public void testBatchLoadClientException() throws Exception {
    ...
    Mockito.doThrow(RemoteInvocationException.class).when(mockClient).batchGetV2(
        ...
        Mockito.anySet(),
        Mockito.any(Authentication.class));
    com.linkedin.datahub.graphql.types.monitor.MonitorType type = new com.linkedin.datahub.graphql.types.monitor.MonitorType(mockClient);
    ...
    assertThrows(RuntimeException.class, () -> type.batchLoad(ImmutableList.of(TEST_MONITOR_URN, TEST_MONITOR_URN_2),
        context));
  }
}