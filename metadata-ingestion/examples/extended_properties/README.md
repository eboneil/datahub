...
```
datahub extended_properties create -f extended_properties.yaml
```


```
datahub extended_properties create --name io.acryl.privacy.retentionTime --type STRING --cardinality MULTIPLE --entity_type DATASET --entity_type DATAFLOW
```
